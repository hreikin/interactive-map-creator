...
class ImageGallery():
    ...
    def fetch_files(self):
        ...
        # This section is only here until i can figure out caching with classes in streamlit, at 
        # which point i will create a child class and inherit from this, current errors include:
        # 
        # `streamlit typeerror: cachedfunc.__init__() takes 2 positional arguments but 4 were given`
        # `missing 1 required positional argument: 'self'`
        if self.directory.name == "maps" or self.directory.name == "tiles":
